...
void pc_engine_cmd_toggle_echocancel(struct pc_context *pctx);
int  pc_engine_cmd_set_echocancel(struct pc_context *pctx, int type, int param);  // AEC
