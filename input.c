...
/* AEC */
	{ "echocancel", 'E', 2, { {ct_int, "type", 0, 1, 0.0, 2.0, &cmd_aec_type}, {ct_int, "param", 0, 1, 0.0, 1000000.0, &cmd_aec_param} }, "set AEC type and param", "0:disabled, 1:speex param=filterLength, 2: webRTC param=latency", NULL },
/* AEC */
